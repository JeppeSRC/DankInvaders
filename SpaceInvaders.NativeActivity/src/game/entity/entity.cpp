...
Entity::Entity(vec3 position, vec2 size, ENTITY_TYPE type, GameManager* manager) : type(type), position(position), size(size), color(vec4(1, 1, 1, 1)), texture(nullptr), manager(manager) { }
